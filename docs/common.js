...
(function () {
  ...
  if (!articles) return;
  var items = articles.querySelectorAll('.articles__item');
  if (!items || !items.length) return;
  items.forEach(function (item) {
    var head = item.querySelector('.articles__item-head');
...
// EXTERNAL MODULE: ./src/blocks/header/header.js
...
(function () {
  var teamSwiper = new Swiper('.team__cards', {
    modules: [Navigation],
    slidesPerView: 1,
    spaceBetween: 25,
    centeredSlides: true,
...
// EXTERNAL MODULE: ./src/blocks/articles/articles.js
var articles = __webpack_require__(822);
;// ./src/blocks/information/information.js


(function () {
  var infoSwiper = new Swiper('.information__swiper', {
...
;// ./src/blocks/stock/stock.js
function stock_typeof(o) { "@babel/helpers - typeof"; return stock_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, stock_typeof(o); }
function stock_defineProperty(e, r, t) { return (r = stock_toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function stock_toPropertyKey(t) { var i = stock_toPrimitive(t, "string"); return "symbol" == stock_typeof(i) ? i : i + ""; }
function stock_toPrimitive(t, r) { if ("object" != stock_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != stock_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }


(function () {
  var swiper = new Swiper('.stock__swiper', stock_defineProperty(stock_defineProperty({
    modules: [Pagination, Navigation],
    slidesPerView: 1,
    spaceBetween: 20,
    pagination: {
